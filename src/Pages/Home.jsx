...
const TECH_STACK = ["MERN", ".NET", "FLUTTER", "KOTLIN"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Madhuka-Dilshan" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/mdilshan/" },
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  A Software Engineering student focusing on developing coding skills, solving problems, and creating innovative software solutions.
                </p>
